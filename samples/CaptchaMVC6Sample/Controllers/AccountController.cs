...
using CaptchaMVC6Sample;
using CaptchaMVC6Sample.Models;
using CaptchaMVC6Sample.Services;
using CaptchaMVC6;
using Microsoft.AspNet.Http;

namespace CaptchaMVC6Sample.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        const string SessionKeyPrefix_LoginTryTime = "LoginTryTime_";
